...
const Anecdote = ({ anecdote }) => (
  <div>
    ...
    more info @ <a href={anecdote.info} target="!blank">{anecdote.info}</a>
  </div>
)
  ...
  return (
    <div>
      <Router>
        ...
        <Menu />
        {notification ? <div>A new anecdote {notification} created!</div> : <div/>}
        <Route exact path="/" render={() => <AnecdoteList anecdotes={anecdotes} />}/>
        <Route path="/create" render={() => <CreateNew addNew={addNew} setNotification={setNotification} />} />
        <Route path="/about" render={() => <About />} />
        <Route exact path="/anecdotes/:id" render={({ match }) => <Anecdote anecdote={anecdotes.find(anecdote => anecdote.id === match.params.id)}/> } />
        <Footer />
      </Router>
    </div>
  )
